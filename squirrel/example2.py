...
try:
    ...
    x1 = m.addVar(vtype=GRB.CONTINUOUS, name="x1", lb=0, ub=1)
    x2 = m.addVar(vtype=GRB.CONTINUOUS, name="x2", lb=0, ub=1)
    x3 = m.addVar(vtype=GRB.CONTINUOUS, name="x3", lb=0, ub=1)
